...
export const siteMeta = {
    ...
    siteDesc:
        'リオンドールは、ビジネス・ファッション・トレンドを突いた最新情報をお届けしています。ファッション、ビューティーはもちろん話題のSDGsやNFTの情報まで様々な内容を取り揃えています。皆さまにとって「見て、知って、体感して、感じて」をありのままに堪能できるメディアをお楽しみください。',
...
export const adminNaviData = [
    ...
    { name: 'First Class管理', link: '/liondor/admin/first_class/create' },
...
export const catNavData = {
    fashion: [
        { name: 'All Topics', slug: 'fashion', link: '/liondor/post/fashion' },
        {
            name: 'News',
            slug: 'news_fashion',
            link: '/liondor/post/news_fashion',
        },
        {
            name: 'Trend',
            slug: 'trend_fashion',
            link: '/liondor/post/trend_fashion',
        },
        { name: 'Snap', slug: 'snap', link: '/liondor/post/snap' },
        {
            name: 'First Class',
            slug: 'firstclass_fashion',
            link: '/liondor/post/firstclass_fashion',
        },
    ],
    beauty: [
        { name: 'All Topics', slug: 'beauty', link: '/liondor/post/beauty' },
        {
            name: 'News',
            slug: 'news_beauty',
            link: '/liondor/post/news_beauty',
        },
        {
            name: 'Trend',
            slug: 'trend_beauty',
            link: '/liondor/post/trend_beauty',
        },
        ...
        { name: 'Expart', slug: 'expartt', link: '/liondor/post/expartt' },
        {
            ...
            link: '/liondor/post/firstclass_beauty',
        },
    ],
    trend: [
        ...
        { name: 'SDGs', slug: 'sdgs', link: '/liondor/post/sdgs' },
        {
            name: 'Metaverse',
            slug: 'metaverse',
            link: '/liondor/post/metaverse',
        },
        {
            name: 'Virtual Currency',
            slug: 'virtualcurrency',
            link: '/liondor/post/virtualcurrency',
        },
        {
            name: 'Blockchain',
            slug: 'blockchain',
            link: '/liondor/post/blockchain',
        },
        { name: 'NFT', slug: 'nft', link: '/liondor/post/nft' },
        {
            name: 'Space Business',
            slug: 'spacebusiness',
            link: '/liondor/post/spacebusiness',
        },
        {
            name: 'First Class',
            slug: 'firstclass_trend',
            link: '/liondor/post/firstclass_trend',
        },
    ],
    lifestyle: [
        {
            name: 'All Topics',
            slug: 'lifestyle',
            link: '/liondor/post/lifestyle',
        },
        {
            name: 'News',
            slug: 'news_lifestyle',
            link: '/liondor/post/news_lifestyle',
        },
        ...
        { name: 'Interior', slug: 'interior', link: '/liondor/post/interior' },
        {
            name: 'Real Estate',
            slug: 'realestate',
            link: '/liondor/post/realestate',
        },
        { name: 'Travel', slug: 'travel', link: '/liondor/post/travel' },
        {
            name: 'Entertaiment',
            slug: 'entertaiment',
            link: '/liondor/post/entertaiment',
        },
        {
            name: 'First Class',
            slug: 'firstclass_lifestyle',
            link: '/liondor/post/firstclass_lifestyle',
        },
    ],
    wedding: [
        { name: 'All Topics', slug: 'wedding', link: '/liondor/post/wedding' },
        {
            name: 'News',
            slug: 'news_wedding',
            link: '/liondor/post/news_wedding',
        },
        { name: 'Dress', slug: 'dress', link: '/liondor/post/dress' },
        {
            name: 'Wedding Hall',
            slug: 'weddinghall',
            link: '/liondor/post/weddinghall',
        },
        {
            name: 'Accessory',
            slug: 'accessory',
            link: '/liondor/post/accessory',
        },
        ...
        { name: 'Present', slug: 'present', link: '/liondor/post/present' },
        {
            ...
            link: '/liondor/post/firstclass_wedding',
        },
    ],
    topleader: [
        {
            name: 'All Topics',
            slug: 'topleader',
            link: '/liondor/post/topleader',
        },
        {
            name: 'Interview',
            slug: 'interview',
            link: '/liondor/post/interview',
        },
    ...
    video: [{ name: 'All Topics', slug: 'video', link: '/liondor/post/video' }],
}
...
export const brand = [
    ...
    {
        initial: 'H',
        group: [{ name: 'HARRY WINSTON' }, { name: 'Hermès' }],
    },
    {
        initial: 'I',
        group: [],
    ...
    {
        initial: 'J',
        group: [{ name: 'JIL SANDER' }, { name: 'Jimmy Choo' }],
    },
    {
        initial: 'K',
        group: [],
...
export const cosmetic = [
    {
        initial: 'A',
        group: [{ name: 'ADDICTION' }, { name: 'ALBION' }, { name: 'ANNASUI' }],
    },
    {
        initial: 'B',
        group: [{ name: 'BOBBI BROWN' }],
    },
    {
        initial: 'C',
        group: [
    ...
    {
        initial: 'E',
        group: [{ name: 'est' }, { name: 'ESTEELAUDER' }, { name: 'ETVOS' }],
    },
    {
        initial: 'F',
        group: [],
    ...
    {
        initial: 'J',
        group: [{ name: 'JILLSTUART' }],
    },
    {
        initial: 'K',
        group: [{ name: 'KesalanPatharan' }],
    },
    {
        initial: 'L',
        group: [
    ...
    {
        initial: 'M',
        group: [{ name: 'MAKE UP FOEVER' }, { name: 'M・A・C' }],
    },
    {
        initial: 'N',
        group: [{ name: 'NARS' }, { name: 'NOEVIR' }],
    },
    {
        initial: 'O',
        group: [{ name: 'ORLANE' }],
    ...
    {
        initial: 'T',
        group: [{ name: 'THREE' }, { name: 'TOMFORD' }, { name: 'TWANY' }],
    },
    {
        initial: 'U',
        group: [],
