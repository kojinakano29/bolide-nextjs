...
export const getServerSideProps = async ({ params }) => {
    const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_CORAPURA}/mypage/edit/${params.id}`,
    )
...
const EditCompany = ({ posts }) => {
    ...
    const [preview1, setPreview1] = useState(
        profile.image1
            ? `${process.env.NEXT_PUBLIC_BACKEND_URL}/storage/${profile.image1}`
            : '',
    )
    const [preview2, setPreview2] = useState(
        profile.image2
            ? `${process.env.NEXT_PUBLIC_BACKEND_URL}/storage/${profile.image2}`
            : '',
    )
    const [preview3, setPreview3] = useState(
        profile.image3
            ? `${process.env.NEXT_PUBLIC_BACKEND_URL}/storage/${profile.image3}`
            : '',
    )
    ...
    const onProfileUpdate = useCallback(
        async data => {
            ...
            await axios
                .post(`/api/corapura/mypage/update/${profile.id}`, params, {
                    headers: {
    ...
    const onCompanyProfileUpdate = useCallback(
        async data => {
            await csrf

            await axios
                .post(
                    `/api/corapura/mypage/c_company_profile/update/${option.id}`,
                    data,
                )
                .then(res => {
                    // console.log(res)
    ...
    const onSubmit = useCallback(
        async data => {
            ...
            await onProfileUpdate({
                ...
                image1:
                    data.image1.length !== 0 ? data.image1[0] : profile.image1,
                image2:
                    data.image2.length !== 0 ? data.image2[0] : profile.image2,
                image3:
                    data.image3.length !== 0 ? data.image3[0] : profile.image3,
                thumbs:
                    data.thumbs.length !== 0 ? data.thumbs[0] : profile.thumbs,
            })
    ...
    const handleClickEdit = async (type, id) => {
        ...
        if (type === 'business_information') {
            await axios
                .post(`/api/corapura/businessinformation/edit/${id}`)
                .then(res => {
                    // console.log(res)
            ...
            await axios
                .post(`/api/corapura/office/edit/${id}`)
                .then(res => {
            ...
            await axios
                .post(`/api/corapura/president/edit/${id}`)
                .then(res => {
                    // console.log(res.data)
                    setEditData(res.data)
                })
            ...
            await axios
                .post(`/api/corapura/item/edit/${id}`)
                .then(res => {
                    // console.log(res.data)
                    setEditData(res.data)
                })
            ...
            await axios
                .post(`/api/corapura/sust/edit/${id}`)
                .then(res => {
                    // console.log(res.data)
                    setEditData(res.data)
                })
            ...
            await axios
                .post(`/api/corapura/card/edit/${id}`)
                .then(res => {
                    // console.log(res.data)
                    setEditData(res.data)
                })
            ...
            await axios
                .post(`/api/corapura/coupon/edit/${id}`)
                .then(res => {
                    // console.log(res.data)
                    setEditData(res.data)
                })
            ...
            await axios
                .post(`/api/corapura/like/edit/${id}`)
                .then(res => {
                    // console.log(res.data)
                    setEditData(res.data)
                })
            ...
            await axios
                .post(`/api/corapura/mypage/c_company_social/edit/${id}`)
                .then(res => {
                    // console.log(res)
                    setEditData(res.data)
                })
    ...
    const handleClickDelete = async (type, id) => {
        ...
        if (type === 'business_information') {
            await axios
                .delete(`/api/corapura/businessinformation/delete`, {
                    data: {
            ...
            await axios
                .delete(`/api/corapura/office/delete`, {
                    data: {
                        c_office_id: id,
                        c_profile_id: profile.id,
                    },
            ...
            await axios
                .delete(`/api/corapura/president/delete`, {
                    data: {
                        c_president_id: id,
                        c_profile_id: profile.id,
                    },
            ...
            await axios
                .delete(`/api/corapura/item/delete`, {
                    data: {
                        c_item_id: id,
                        c_profile_id: profile.id,
                    },
            ...
            await axios
                .delete(`/api/corapura/sust/delete`, {
                    data: {
                        c_sust_id: id,
                        c_profile_id: profile.id,
                    },
            ...
            await axios
                .delete(`/api/corapura/card/delete`, {
                    data: {
                        c_card_id: id,
                        c_profile_id: profile.id,
                    },
            ...
            await axios
                .delete(`/api/corapura/coupon/delete`, {
                    data: {
                        c_coupon_id: id,
                        c_profile_id: profile.id,
                    },
            ...
            await axios
                .delete(`/api/corapura/like/delete`, {
                    data: {
                        c_like_id: id,
                        c_profile_id: profile.id,
                    },
            ...
            await axios
                .delete(`api/corapura/mypage/c_company_social/delete`, {
                    data: {
                                ...
                                <div className={styles.profileLeft}>
                                    {previews.map((preview, index) => (
                                        <div key={index}>
                                            ...
                                            <label
                                                className={`hoverEffect ${styles.fileBtn}`}>
                                                ファイルから画像を選択
                                                <span>アップロード</span>
                                                <input
                                                    type="file"
                                ...
                                <div className={styles.profileRight}>
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            {errors.profile?.types.required && (
                                                <p
                                                    className={`red ${styles.error}`}>
                                                    {
                                                        errors.profile.types
                                                            .required
                                                    }
                                                </p>
                                            )}
