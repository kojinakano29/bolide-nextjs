...
const CompanyList = ({ posts }) => {
    ...
    const handleChangePresident = useCallback(
        async e => {
    ...
    const handleChangeSust = useCallback(
        async e => {
    ...
    const handleChangeBusinessInformation = useCallback(
        async e => {
                    ...
                    <>
                        <article className={styles.list}>
                            {company.map((comp, index) => (
                                <a
                                    href={`/corapura/company/${comp?.user?.id}`}
                                    key={index}>
                                    <div className={styles.imgBox}>
                                        <img
                                            src={
                                                comp.thumbs
                                                    ? `${process.env.NEXT_PUBLIC_BACKEND_URL}/storage/${comp.thumbs}`
                                                    : dummy.src
                                            }
                                            alt="企業情報のサムネイル画像"
                                        />
