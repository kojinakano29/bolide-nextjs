...
export const getServerSideProps = async () => {
    const res = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/administar/user`,
    )
...
const UserList = ({ posts }) => {
    ...
    }, [setUsers, setNowPage, setMaxPage, search, page])
                                ...
                                {users.map((use, index) => (
                                    <li
                                        ...
                                        <p className={styles.txt}>
                                            ...
                                            {use.l_profile ? (
                                                <a
                                                    href={`/liondor/mypage/edit/${use.l_profile?.id}`}>
                                                    {use.l_profile?.nicename}
                                                </a>
                                            ) : (
                                                '未作成'
                                            )}
                                        ...
                                        <p className={styles.txt}>
                                            ...
                                            {use.d_profile ? (
                                                <a
                                                    href={`/dellamall/mypage/${use.id}`}>
                                                    {use.d_profile?.nicename}
                                                </a>
                                            ) : (
                                                '未作成'
                                            )}
