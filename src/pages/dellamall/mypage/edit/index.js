...
const EditMypage = () => {
        ...
        await axios
            ...
            .then(res => {
                ...
                if (res.data) {
                    ...
                    if (res.data.thumbs) {
                        setPreview(
                            `${process.env.NEXT_PUBLIC_BACKEND_URL}/storage/${res.data.thumbs}`,
                        )
                    }
                } else {
    ...
    const onMypageEdit = useCallback(
        async data => {
            await csrf()
            ...
            await axios
                .post(`/api/dellamall/mypage/update/${editData.id}`, params, {
                    headers: {
                        ...
                        <article className={styles.adminForm}>
                            ...
                            <dl>
                                ...
                                <dd className={styles.profileThumbs}>
                                    ...
                                    <label
                                        htmlFor="thumbs"
                                        className={`${styles.thumbsBox} hoverEffect`}>
                                        画像を選択する
                                        <input
                                            type="file"
                                            id="thumbs"
