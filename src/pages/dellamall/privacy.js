...
const Privacy = () => {
  return (
    <section className="cont1">
      <Container small900>
        <h2 className={`${styles.ttl} ttl2`}>プライバシーポリシー</h2>
        <p>
          株式会社Bolide's（以下「当社」）は、以下のとおり個人情報保護方針を定め、個人情報保護の仕組みを構築し、全従業員に個人情報保護の重要性の認識と取組みを徹底させることにより、個人情報の保護を推進致します。
        </p>
        <ul className={styles.ul}>
          ...
          <li>
            ...
            <p>
              ...
              <br />
              株式会社Bolide's<br />
              〒460-0008　愛知県名古屋市中区栄3丁目35番地34号　栄タワーヒルズ2503号<br />
              TEL.052-678-2415<br />
            </p>
          </li>
        </ul>
