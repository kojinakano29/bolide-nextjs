        ...
        <>
            <div className={styles.fixed_btn}>
                <a className="hoverEffect" href="/contact/?type=request">
                    <img
                        className="pc"
                        src="/top/fixed_btn.webp"
                        alt="無料で確認　BJについて資料はコチラ"
                    />
                    <img
                        className="sp"
                        src="/top/fixed_btn_sp.webp"
                        alt="無料で確認　BJについて資料はコチラ"
                    />
                </a>
            </div>
            ...
            <section className={styles.mv}>
                <div className={styles.mvBox}>
                    <img
                        className="pc"
                        src="/top/mv-text.svg"
                        alt="つながりを強化する新世代SNSBolide's Japan　自らの攻めが生きる”連鎖型SNS”という選択"
                    />
                    <img
                        className="sp"
                        src="/top/mv-text__sp.svg"
                        alt="つながりを強化する新世代SNSBolide's Japan　自らの攻めが生きる”連鎖型SNS”という選択"
                    />
                </div>
            ...
            <section id="about" className={styles.aboutArea}>
                <Container small900>
                    ...
                    <p className={styles.desc}>
                        ...
                        もちろん、認知拡大にも効果的。
                        <br />
                        <span>中間マージンは一切かかりません。</span>
                        <br />
                        あなたの目的次第で何にでもなれる
                        <br className="sp" />
                        「BJ（通称 ビージェイ）」今始めてみませんか？
                    </p>
                    <div className={styles.imgBox}>
                        <img
                            className="pc"
                            src="/top/about.svg"
                            alt="Bolide's Japanとは？"
                        />
                        <img
                            className="sp"
                            src="/top/about__sp.svg"
                            alt="Bolide's Japanとは？"
                        />
                    </div>
                </Container>
                    ...
                    <div className={styles.flexType1}>
                        <div className={styles.left}>
                            ...
                            <p className={styles.desc}>
                                ...
                                <br />
                                ボリードジャパン側から「安心」「つながり」「貢献」という視点で選ばれた個人や企業等だけが
                                <br />
                                参加できるクラブです。選ばれた個人や企業には個々の会員ページにBJC認定マークが付与されます。
                                <br />
                                BJC認定マークは個人や企業等とつながる上で有意義な認定マークとなるようボリードジャパンも
                                <br />
                                厳正かつ公平に選定、認定を行います。BJC詳細認定基準は非公開となります。
                            </p>
                        </div>
                    ...
                    <div className={styles.flexType2}>
                        <div className={styles.left}>
                            ...
                            <p className={styles.midashi}>
                                BJCは全ての人や企業、地域とのつながりを重視し、安心して利用できるクラブを目指します。
                            </p>
                            <p className={styles.desc}>
                                BJCは個と企業、個と地域、個と個という、まずは「個」を中心とした企業や地域とのつながりを大切にします。そして企業と企業、地域と地域、地域と企業という更なる発展を支援します。
                                <br />
                                積極的なつながりの中で安心・信頼が自らの成長や発展につながるような取り組みをしていきます。
                            </p>
                        </div>
                        <div className={styles.right}>
                            <img
                                src="/top/bjc__2.svg"
                                alt="BJC(Bolide's Japan Club)"
                            />
                        </div>
                    </div>
                    <div className={styles.flexType2}>
                        <div className={styles.left}>
                            ...
                            <p className={styles.midashi}>
                                BJCは皆様の積極的な社会貢献活動、SDGs/社会貢献の取り組みを支援します。
                            </p>
                            <p className={styles.desc}>
                                BJCはSDGs/社会貢献の前文にある「人間と地球、そして繁栄のための行動計画」を個人・企業が積極的に取り組む姿勢を支援します。
                                <br />
                                「経済」と「社会」と「環境」のバランスを維持しつつ、世界の個人・企業等がよりよくつながり、変化することができるような取り組みをしていきます。
                                <br />
                                ボリードジャパンでは社会貢献枠としての月額利用料金プランに追加できるサステナブルオプション※を設け、「人間」「平和」「繁栄」「地球環境」への貢献活動を皆様と共に支援していきます。
                                <br />
                                <br />
                                ※会員登録完了後にオプションの追加が可能になります。
                            </p>
                        </div>
                        <div className={styles.right}>
                ...
                <Container small900>
                    ...
                    <div className={styles.flex}>
                        <a href="/corapura">
                            <img
                                className="pc"
                                src="/top/corapura-banner.svg"
                                alt="CORAPURA"
                            />
                            <img
                                className="sp"
                                src="/top/corapura-banner__sp.svg"
                                alt="CORAPURA"
                            />
                        ...
                        <a href="/liondor">
                            <img
                                className="pc"
                                src="/top/liondor-banner.svg"
                                alt="LIONDOR"
                            />
                            <img
                                className="sp"
                                src="/top/liondor-banner__sp.svg"
                                alt="LIONDOR"
                            />
                        ...
                        <a href="/dellamall">
                            <img
                                className="pc"
                                src="/top/della-banner.svg"
                                alt="Della Mall"
                            />
                            <img
                                className="sp"
                                src="/top/della-banner__sp.svg"
                                alt="Della Mall"
                            />
                        ...
                        <a
                            ...
                            <img
                                className="pc"
                                src="/top/marche-banner.svg"
                                alt="Marche Dor"
                            />
                            <img
                                className="sp"
                                src="/top/marche-banner__sp.svg"
                                alt="Marche Dor"
                            />
