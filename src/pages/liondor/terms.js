                ...
                <article className={styles.article}>
                    <div className={styles.box}>
                        <p>
                            ...
                            Japan」内のコンテンツ「LIONDOR（リオンドール）」（以下「本サービス」といいます）の利用について、以下の通り利用規約（以下「本規約」といいます）を定めます。本サービスには、本サービスを通じての情報閲覧やプレゼント応募等が含まれます。本サービスの利用者は、予めBolide’s
                            Japan利用規約、株式会社Bolide’s規約に付随するホワイトペーパー、並びに本規約に同意した上で、Bolide’s
                            Japan会員（以下「会員」といいます）として、本サービスを利用するものとします。また、本規約で使用する用語は、本規約で別段定める場合を除き、全てBolide’s
                            Japan利用規約の用語と同一の定義とします。
                        </p>
                    </div>
                    <div className={styles.box}>
                    ...
                    <div className={styles.box}>
                        ...
                        <p>
                            ...
                            <br />
                            2.当社は前項による本規約の変更にあたり、変更後の本規約の効力発生日の１か月前までに、本規約を変更する旨及び変更後の本規約の内容とその効力発生日は本サイトに掲示し、または会員に電子メールで通知等、当社が適当と判断する方法により行います。
                            <br />
                    ...
                    <div className={styles.box}>
                        <h3>【第12条　プレゼント応募】</h3>
                        <p>
                            1.プレゼントへの応募は、マイページの必須事項のご記入とLIONDOR
                            SNSを最低1つフォローして頂いた方に限らせていただきます。
                            <br />
                    ...
                    <div className={styles.box}>
                        ...
                        <p>
                            ...
                            <br />
                            &#9312;本契約日から１週間以内の解約の場合：制作費及び掲載費合計額の20％相当額
                            <br />
                            &#9313;本契約日から１週間超2週間以内の解約の場合：制作費及び掲載費合計額の50％相当額
                            <br />
                    ...
                    <div className={styles.box}>
                        ...
                        <p>
                            ...
                            <br />
                            &#9313;申込者は、当社の書面による承諾なく第１項の成果物の全部又は一部を配布しないことを約します。
                            <br />
                            ...
                            <br />
                            &#9315;第３項又は前項に違反した場合は、損害賠償や刑事処分の対象となることがあります。
                        </p>
                    </div>
                    <div className={styles.box}>
                        <h3>【第24条　リンク】</h3>
