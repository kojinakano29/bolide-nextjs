            ...
            <Container>
                <div className={styles.whatIs}>
                    ...
                    <p className={styles.txt2}>
                        「見て、知って、体感して、感じて」
                        <span className={styles.txt}>をありのままに。</span>
                    </p>
                </div>
                <div className={styles.merit}>
                    ...
                    <div className={styles.flex}>
                        ...
                        <div className={styles.box}>
                            ...
                            <a href="/liondor/present" className={styles.link}>
                                プレゼント応募はこちら
                            </a>
                        </div>
                        <div className={styles.box}>
                            ...
                            <a href="/liondor/contact" className={styles.link}>
                                お問い合わせはこちらから
                            </a>
                        </div>
                        <div className={styles.box}>
                ...
                <a href="/register" target="_blank" className="btn4">
                    会員登録はこちら
                </a>
            </Container>
        </section>
