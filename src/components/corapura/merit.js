...
const Merit = ({ detail = false }) => {
    return (
        <section
            className={`${styles.meritBox} ${detail ? styles.detail : null}`}>
            <Container small>
                <h2 className={styles.ttl}>
                    <span className="en">8</span>つのメリット
                </h2>
                <ul className={styles.list}>
                    <li>
                        <img src={merit1.src} alt="案件登録で気軽に依頼" />
                        <div className={styles.height40}>
                            案件登録で<span>気軽に依頼</span>
                        </div>
                        <p>
                            かんたん案件登録で多方面のユーザーに気軽に依頼。お仕事、売買、告知、拡散、求人、仲間募集など案件登録内容は自由。
                        </p>
                    </li>
                    <li>
                        <img src={merit2.src} alt="スキマ時間を活用" />
                        <div className={styles.height40}>
                            <span>スキマ時間</span>を活用
                        </div>
                        <p>
                            フリーランスも個人ユーザーも専門家もスキマ時間を有効に活用してお仕事をかんたん受注。
                        </p>
                    </li>
                    <li>
                        <img
                        ...
                        <p>
                            企業・個人・自治体などの中から共創相手・コラボ相手を見つける。パートナー探しに活用！
                        </p>
                    </li>
                    <li>
                        <img
                            src={merit4.src}
                            alt="＂直接つながる＂で中間マージンは一切なし"
                        />
                        <div className={styles.height40}>
                            <span>＂直接つながる＂</span>で<br />
                            中間マージンは一切なし
                        </div>
                        <p>
                            企業・個人・自治体などの中から共創相手・コラボ相手を見つける。パートナー探しに活用！
                    ...
                    <li>
                        ...
                        <p>
                            コラプラでできるアピール方法はなんと12種類。多方面からのアプローチで認知拡大。
                        </p>
                    </li>
                    <li>
                        <img
                            src={merit6.src}
                            alt="SDGs/社会貢献・NFTなど取り入れ企業力UP"
                        />
                        <div className={styles.height60}>
                            <span>SDGs/社会貢献・NFT</span>
                            <br className="sp" />
                            など取り入れ
                            <br />
                            企業力<span>UP</span>
                    ...
                    <li>
                        ...
                        <p>
                            インスタで「お仕事依頼はDMまで」と待っているだけで良いですか？コラプラで自己アピールにて認知拡大。
                        </p>
                    </li>
                    <li>
                        <img
                        ...
                        <p>
                            自分の推し活・趣味・特技をここぞとばかりに披露。そこから広がる・深まる・つながる仲間の輪。
                        </p>
                    </li>
                </ul>
                <div className={styles.btnCover}>
                    <Btn txt="CORAPURAとは" link="/corapura/guide" reverse />
                </div>
            </Container>
        </section>
    )
