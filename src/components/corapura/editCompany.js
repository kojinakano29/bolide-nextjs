...
const EditCompanyForm = () => {
    ...
    const onSubmitBusinessInformation = async data => {
        ...
        await axios
            .post(`/api/corapura/businessinformation/update/${targetId}`, {
    ...
    const onSubmitOffice = async data => {
        ...
        await axios
            .post(`/api/corapura/office/update/${targetId}`, {
                c_profile_id: profile.id,
    ...
    const onSubmitPresident = async data => {
        ...
        const datas = {
            ...
            thumbs:
                data.presidentThumbs && data.presidentThumbs?.length !== 0
                    ? data.presidentThumbs[0]
                    : editData.thumbs,
        }
        ...
        await axios
            .post(`/api/corapura/president/update/${targetId}`, params, {
                headers: {
    ...
    const onSubmitItem = async data => {
        ...
        const datas = {
            ...
            thumbs:
                data.itemThumbs && data.itemThumbs?.length !== 0
                    ? data.itemThumbs[0]
                    : editData.thumbs,
        }
        ...
        await axios
            .post(`/api/corapura/item/update/${targetId}`, params, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
            })
    ...
    const onSubmitSust = async data => {
        ...
        const datas = {
            ...
            thumbs:
                data.sustThumbs && data.sustThumbs?.length !== 0
                    ? data.sustThumbs[0]
                    : editData.thumbs,
        }
        ...
        await axios
            .post(`/api/corapura/sust/update/${targetId}`, params, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
            })
    ...
    const onSubmitCoupon = async data => {
        ...
        const datas = {
            ...
            thumbs:
                data.couponThumbs && data.couponThumbs?.length !== 0
                    ? data.couponThumbs[0]
                    : editData.thumbs,
        }
        ...
        await axios
            .post(`/api/corapura/coupon/update/${targetId}`, params, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
            })
    ...
    const onSubmitSns = async data => {
        ...
        await axios
            .post(`/api/corapura/mypage/c_company_social/update/${targetId}`, {
  ...
  TEL:000-0000-0000`}></textarea>
                            ...
                            {type === 'president' ? (
                                <form
                                    onSubmit={handleSubmit(onSubmitPresident)}>
                                    <dl>
                                        <dt>
