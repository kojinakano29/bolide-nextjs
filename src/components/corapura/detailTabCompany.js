                  ...
                  <>
                    <div className={styles.column3}>
                      {matter.length !== 0 ?
                        ...
                        :
                        <p className={styles.noneText}>この企業の案件がありません</p>
                      }
                    </div>
                ...
                {tab1 === 1 ?
                  <>
                    {filterMatching.length !== 0 ?
                      ...
                      :
                      <p className={styles.noneText}>まだコラプラした企業・ユーザーがいません</p>
                    }
                ...
                {tab2 === 0 ?
                  <>
                    {business.length !== 0 ?
                      ...
                      :
                      <p className={styles.noneText}>ニュース/イベントがありません</p>
                    }
                ...
                {tab2 === 1 ?
                  <>
                    {filterOffice.length !== 0 ?
                      ...
                      :
                      <p className={styles.noneText}>事務所・店舗がありません</p>
                    }
                ...
                {tab2 === 2 ?
                  <>
                    {president ?
                      ...
                      :
                      <p className={styles.noneText}>プレジデント/リーダーがありません</p>
                    }
                  </>
                : null}
                {tab2 === 3 ?
                  <>
                    {filterNft.length !== 0 ?
                      ...
                      :
                      <p className={styles.noneText}>NFT/製品・商品特許・技術がありません</p>
                    }
                ...
                {tab3 === 0 ?
                  <>
                    {release.length !== 0 ?
                      ...
                      :
                      <p className={styles.noneText}>プレスリリースがありません</p>
                    }
                ...
                {tab3 === 2 ?
                  <>
                    {filterSalon.length !== 0 ?
                      ...
                      :
                      <p className={styles.noneText}>オンラインサロンがありません</p>
                    }
                    {filterSalon.length === 3 && salon.length > 3 ?
                      <div className="btnCover" onClick={handleClickMoreSalon}>
                        <Btn txt="さらに見る" />
                      </div>
                    : null}
                  </>
                ...
                {tab3 === 3 ?
                  <>
                    {filterCoupon.length !== 0 ?
                      ...
                      :
                      <p className={styles.noneText}>クーポンがありません</p>
                    }
                ...
                {tab3 === 4 ?
                  <>
                    {filterSponsor.length !== 0 ?
                      ...
                      :
                      <p className={styles.noneText}>スポンサー・マスコットがありません</p>
                    }
