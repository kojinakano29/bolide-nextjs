  ...
  return (
    <header className={`${styles.header} ${show ? styles.active : null}`}>
      <div className={styles.flex}>
        ...
        {!user ?
          <div className={styles.right}>
            <a href="/corapura/login" className={`${styles.btn} ${styles.login} hoverEffect`}>
              <div className={styles.iconBox}>
                <img src={login.src} alt="ログインのアイコン" />
              </div>
              <span className="pc">ログイン</span>
            </a>
            <a href="/register" className={`${styles.btn} ${styles.signUp} hoverEffect`}>
              <div className={styles.iconBox}>
        ...
        :
          <div className={styles.right}>
            <a href={`/corapura/company/matter/bookmark/${user?.id}`} className={`${styles.btn} ${styles.bookmark} hoverEffect`}>
              <div className={styles.iconBox}>
                <img src={bookmark.src} alt="お気に入りリストのアイコン" />
              </div>
              <span className="pc">お気に入りリスト</span>
            </a>
            <a href={`/corapura/editor`} className={`${styles.btn} ${styles.mypage} hoverEffect`}>
              <div className={styles.iconBox}>
      ...
      >
        ...
        <li>
          <a href="/corapura/influencer/matter" onClick={handleClickHum}>
