...
const DetailAreaLeft = ({ influencer = false }) => {
    ...
    const handleClickSelectImg = useCallback(
        async cur => {
            setCurrentImg(cur)
        },
        [setCurrentImg],
    ...
    return (
        <div
            className={`${styles.detailLeft} ${
                influencer ? styles.influencer : null
            }`}>
            ...
            <div className={styles.selectImg}>
                <button
                    ...
                    onClick={() => handleClickSelectImg(0)}>
                    <img
                        src={
                            profile.image1
                                ? `${process.env.NEXT_PUBLIC_BACKEND_URL}/storage/${profile.image1}`
                ...
                <button
                    type="button"
                    className="hoverEffect"
                    onClick={() => handleClickSelectImg(1)}>
                    <img
                        src={
                            profile.image2
                                ? `${process.env.NEXT_PUBLIC_BACKEND_URL}/storage/${profile.image2}`
                ...
                <button
                    type="button"
                    className="hoverEffect"
                    onClick={() => handleClickSelectImg(2)}>
                    <img
                        src={
                            profile.image3
                                ? `${process.env.NEXT_PUBLIC_BACKEND_URL}/storage/${profile.image3}`
