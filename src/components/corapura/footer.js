    ...
    return (
        <footer className={styles.footer}>
            <div className={styles.footer1}>
                <Container small>
                    <p className={`${styles.footer1__title} en`}>
            ...
            <div className={styles.footer2}>
                <Container small>
                    <div className={styles.footer__cont1}>
                        <a
                            href="/corapura"
                            className={`${styles.footer__logo} hoverEffect`}>
                            <Image
                                src={logo}
                                alt="CORAPURA"
                                layout="responsive"
                        ...
                        <ul className={styles.footer__cont1List}>
                            <li
                                className={`${styles.footer__cont1Item} hoverEffect`}>
                                <a href="/corapura/company/matter">企業案件</a>
                            </li>
                            <li
                                className={`${styles.footer__cont1Item} hoverEffect`}>
                                <a href="/corapura/influencer/matter">
                                    インフルエンサー案件
                                </a>
                            </li>
                            <li
                    ...
                    <ul className={styles.footer__cont3}>
                        ...
                        <li
                            className={`${styles.footer__cont3Item} hoverEffect`}>
                            <a href="/corapura/terms">
                                利用規約・コンテンツの基準
                            </a>
                        </li>
                        <li
                            className={`${styles.footer__cont3Item} hoverEffect`}>
                            <a href="/tokushoho">特定商品取引法に基づく表記</a>
                        </li>
                        <li
                            className={`${styles.footer__cont3Item} hoverEffect`}>
