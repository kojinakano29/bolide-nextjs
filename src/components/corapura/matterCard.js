        ...
        <>
            {list ? (
                <article className={`${styles.matterCard} ${styles.list}`}>
                    ...
                    <a
                        href={`/corapura/${
                            matter?.user?.account_type === 0
                                ? 'influencer'
                                : 'company'
                        }/${matter?.user?.id}`}
                        className={`${styles.company} hoverEffect`}>
                        <div className={styles.logoBox}>
                            {matter?.user?.c_profile?.thumbs ? (
                                <img
                                    src={`${process.env.NEXT_PUBLIC_BACKEND_URL}/storage/${matter?.user?.c_profile?.thumbs}`}
                                    alt="プロフィール画像"
                                />
                            ) : null}
                        </div>
