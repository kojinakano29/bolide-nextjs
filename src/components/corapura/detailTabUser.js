...
const DetailTabUser = ({ cards, likes, matters, userInfo }) => {
    ...
    const handleClickTabBox1 = useCallback(async () => {
        ...
        await axios
            .post(`/api/corapura/matching_user/tab_return`, {
                user_id: userInfo.id,
            })
            .then(res => {
                // console.log(res)
                                                        ...
                                                        <a
                                                            ...
                                                            <div
                                                                ...
                                                                <img
                                                                    src={
                                                                        match.thumbs
                                                                            ? `${process.env.NEXT_PUBLIC_BACKEND_URL}/storage/${match.thumbs}`
                                                                            : dummy.src
                                                                    }
                                                                    alt="案件の画像"
                                                                />
