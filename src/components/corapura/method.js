      ...
      <Container small>
          ...
          <div className={styles.left}>
            ...
            <div className={styles.putOn__item}>
              ...
              <div className={styles.txtBox}>
                ...
                <span>募集したいカテゴリで案件記事を記入し、投稿</span>
              </div>
            </div>
            <div className={`${styles.putOn__item} ${styles.mt264}`}>
              <div className={styles.imgBox}>
              ...
              <div className={styles.txtBox}>
                ...
                <span>ユーザーからの応募があった場合、マイページに通知がきます！</span>
              </div>
            </div>
          </div>
          ...
          <div className={styles.right}>
            ...
            <div className={`${styles.find__item} ${styles.mt96}`}>
              ...
              <div className={styles.txtBox}>
                ...
                <span>自分のやりたい案件を色んな条件から探してみましょう</span>
              </div>
            </div>
            <div className={styles.find__item}>
              <div className={styles.imgBox}>
            ...
            <div className={styles.find__item}>
              ...
              <div className={styles.txtBox}>
                ...
                <span>採用されれば採用通知がマイページに届きます！</span>
              </div>
            </div>
          </div>
        </article>
          ...
          <div className={`${styles.right} ${styles.mt72}`}>
            <div className={styles.find__item}>
              ...
              <div className={styles.txtBox}>
                ...
                <span>無事案件を完了したら、報酬を受け取りましょう！ ※内容によって流れは変わります</span>
              </div>
            </div>
          </div>
        </article>
        ...
        <div className={styles.linkArea}>
          ...
          <p>
            ...
            <span>「コラボしたい」</span>
            や
            <br className="sp" /><span>「求人募集」</span>
            などなど
            <br className="pc" />報酬が
