...
const EditOfficial = () => {
    ...
    const onSubmitOverview = async data => {
        ...
        await axios
            .post(`/api/dellamall/d_overviews/update/${editData.id}`, {
    ...
    const onSubmitCoupon = async data => {
        ...
        await axios
            .post(`/api/dellamall/d_coupons/update/${editData.id}`, {
    ...
    const onSubmitSocial = async data => {
        ...
        await axios
            .post(`/api/dellamall/d_socials/update/${editData.id}`, {
    ...
    const onSubmitInfo = async data => {
        ...
        await axios
            .post(`/api/dellamall/d_infos/update/${editData.id}`, {
                title: data.infoDate,
    ...
    const onSubmitInstagram = async data => {
        ...
        await axios
            .post(`/api/dellamall/d_insta/update/${editData.id}`, {
    ...
    const onSubmitItem = async data => {
        ...
        await axios
            .post(`/api/dellamall/d_items/update/${editData.id}`, params, {
                headers: {
                ...
                <div
                    ...
                    {disabled ? (
                        ...
                        <article className={styles.formArea}>
                            ...
                            {type === 'instagram' ? (
                                <form
                                    onSubmit={handleSubmit(onSubmitInstagram)}>
                                    <dl>
                                        <dt>
