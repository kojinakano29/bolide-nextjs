    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <article className={styles.formContent}>
                    <dl className={styles.dl}>
                        ...
                        <dd className={styles.checkArea}>
                            ...
                            <label>
                                <input
                                    type="checkbox"
                                    value="既存を公式に更新（無料キャプチャ設定済）"
                                    {...register('content', { required: true })}
                                />
                                既存を公式に更新（無料キャプチャ設定済）
                            </label>
                            {errors.content && (
                                <p className={`orange ${styles.error}`}>
                                    ※こちらの項目は入力必須です
                                </p>
                            )}
                        </dd>
                    ...
                    <dl className={styles.dl}>
                        ...
                        <dd className={styles.long}>
                            <input
                                type="text"
                                {...register('furiganaCompany', {
                                    pattern: furiganaRegExp,
                                })}
                                placeholder="カブシキガイシャサンプル"
                            />
                            {errors.furiganaCompany && (
                                <p className={`orange ${styles.error}`}>
                                    ※カタカナのみ入力してください。
                                </p>
                            )}
                            ...
                            <dl className={styles.dl}>
                                ...
                                <dd className={styles.long}>
                                    <input
                                        ...
                                        placeholder="youremail@example.com"
                                    />
                                    {errors.mail2?.types.required && (
                                        <p className={`orange ${styles.error}`}>
                                            {errors.mail2.types.required}
                                        </p>
                                    )}
                                    {errors.mail2?.types.pattern && (
                                        <p className={`orange ${styles.error}`}>
                                            {errors.mail2.types.pattern}
                                        </p>
                                    )}
                ...
                {!isValid && (
                    <p className={`orange ${styles.error} ${styles.error2}`}>
