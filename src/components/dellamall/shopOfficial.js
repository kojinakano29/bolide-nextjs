...
const shopOfficial = ({ info, salon }) => {
    ...
    useEffect(() => {
        ...
        axios
            .get(
                `https://graph.facebook.com/v14.0/${user_id}?fields=${fields}&access_token=${access_token}`,
            )
            .then(res => {
                // console.log(res)
                ...
                {instagramItem.length !== 0 ? (
                    <>
                        ...
                        <Btn01
                            fa={faInstagram}
                            txt="Instagram"
                            link={`https://www.instagram.com/${instagramItem.username}`}
                            blank
                        />
                    </>
                ) : (
