...
const CreateOfficial = () => {
    ...
    const onSubmitOverview = async data => {
        ...
        await axios
            .post(`/api/dellamall/d_overviews/store/${shop.id}`, {
    ...
    const onSubmitCoupon = async data => {
        ...
        await axios
            .post(`/api/dellamall/d_coupons/store/${shop.id}`, {
    ...
    const onSubmitSocial = async data => {
        ...
        await axios
            .post(`/api/dellamall/d_socials/store/${shop.id}`, {
    ...
    const onSubmitInfo = async data => {
        ...
        await axios
            .post(`/api/dellamall/d_infos/store/${shop.id}`, {
                title: data.infoDate,
    ...
    const onSubmitInstagram = async data => {
        ...
        await axios
            .post(`/api/dellamall/d_insta/store/${shop.id}`, {
    ...
    const onSubmitItem = async data => {
        ...
        await axios
            .post(`/api/dellamall/d_items/store/${shop.id}`, params, {
                headers: {
