...
const CreateMall = () => {
    ...
    const { handleClickPopup, setMallList, user, shop } = useContext(
        CreateMallContext,
    )
    const {
        register,
    ...
    const onCreateMall = useCallback(async data => {
        ...
        await axios
            .post(`/api/dellamall/mall/store`, data)
            .then(res => {
                // console.log(res)
    ...
    return (
        <div className={styles.createMallModal} onClick={handleClickPopup}>
            <form onSubmit={handleSubmit(onSubmit)}>
                <Container small900>
                    <div
                        className={styles.createMallBox}
                        ...
                        <dl>
                            <dt>
                                <label htmlFor="lock">プライベート</label>
                            </dt>
                            <dd>
                                <input
                                    type="checkbox"
