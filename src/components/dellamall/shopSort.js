...
import { SortContext } from '@/pages/dellamall/shop'

const ShopSort = () => {
    const { sort, setSort, account, setAccount } = useContext(SortContext)
        ...
        <div className={styles.sortBox}>
            ...
            <div className={styles.sort}>
                <button
                    ...
                    <p className={styles.state}>
                        アカウント{account ? `：${account.name}` : null}
                    </p>
                </button>
                {openAccount ? (
                    <div className={styles.box}>
