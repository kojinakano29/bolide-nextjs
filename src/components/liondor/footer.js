                ...
                <Container>
                    <div className={styles.topArea}>
                        <div className={styles.left}>
                            <a href="/liondor" className={styles.logo}>
                                <span className={`ivy ${styles.big}`}>
                                    LIONDOR
                                </span>
                                <span className={`ivy ${styles.small}`}>
                                    CREATED BY Bolide's Japan
                                </span>
                            </a>
                            <SnsFollow />
                        </div>
                    ...
                    <div className={styles.bottomArea}>
                        <nav className={styles.bottomLeft}>
                            ...
                            <a href="/liondor/contact?check=present">
                                企業からのプレゼント募集
                            </a>
                            <a href="/liondor/registration">
                                リオンドールについて
                            </a>
                            <a href="/liondor/contact">お問い合わせ</a>
                        </nav>
                        <p className={`en ${styles.copy}`}>
                            © 2023 LIONDOR Inc.
                        </p>
                    </div>
                </Container>
