        ...
        <>
            <div className={styles.adBox}>
                ...
                <p className={`${styles.adTxt2} ${styles.gray}`}>
                    ...
                    <br />
                    ブランドのニュースやコレクション情報、プロフィール紹介などや、ショップ情報の掲載を希望される
                    <br />
                    企業様・ブランド様は下記までご連絡下さい。
                </p>
                <p className={styles.adTxt2}>
                    詳細の注意事項はこちらをご覧ください
                </p>
                <a href="" target="_blank" className="btn3 noto">
                    MEDIA GUIDEはこちら
                </a>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <article className={styles.formContent}>
                    ...
                    <button type="submit" className="btn3 noto">
                        内容を確認する
                    </button>
                </article>
                {!isValid && (
