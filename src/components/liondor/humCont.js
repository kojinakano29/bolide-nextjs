...
const HumCont = ({ humOpen, clickHumClose }) => {
    ...
    return (
        <div className={`${styles.humBox} ${humOpen ? styles.slideIn : ''}`}>
            <Container>
                <nav
                    className={`${styles.humNav} ${
                        humOpen ? styles.lazyIn : ''
                    }`}>
                    <ul className={styles.humUl}>
                        <li>
                            <a
                                href="/liondor/post/fashion"
                                className="ivy"
                ...
                <nav
                    className={`${styles.humNav2} ${
                        humOpen ? styles.lazyIn : ''
                    }`}>
                    <ul>
                        <li>
                            <a
                                href="/liondor/contact"
                                className="ivy"
                                onClick={clickHumClose}>
                                CONTACT
                            </a>
                ...
                <nav
                    ...
                    <ul>
                        <li>
                            <a
                                href="/liondor/contact?check=present"
                                className={styles.jp}
                                onClick={clickHumClose}>
                                企業からのプレゼント募集
                            </a>
                ...
                <div
                    ...
                    <div className={styles.bannerFlex}>
                        <a
                            href="/liondor/present"
                            className="hoverEffect"
                            onClick={clickHumClose}>
                            <img
                                src="/liondor/present_banner1.webp"
                                alt="プレゼントのバナー"
                            />
                        </a>
                        <a
                            ...
                            onClick={clickHumClose}>
                            <img
                                src="/liondor/present_banner2.webp"
                                alt="オンラインサロンのバナー"
                            />
                        </a>
                    </div>
